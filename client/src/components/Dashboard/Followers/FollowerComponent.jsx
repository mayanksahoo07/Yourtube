                  ...
                  <Box width="40%" d="flex">
                      <Box  label="Studio" cursor="pointer"  width="2.3rem" height="2.3rem" borderRadius="50%" >
                                ...
                                <Box pl={5}>
                                    <Box d="flex">
                                      <Link to={`/profile/${userId}`}>
                                        <Text as="h3" color={mode === "light" ? "#101011" : "#FFD600"} fontWeight="600" cursor="pointer">{username.slice(0,12)}</Text>
                                      </Link>
                                        {isVerified && <Box pl={2} pt={1}><AiFillCheckCircle fill={mode==="light" ? "#5B61FB" : "#FFD600"}/></Box>}
                                    </Box>
