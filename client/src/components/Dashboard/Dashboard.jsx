...
const Pages = () => {
  return (
    <>
            ...
            <Sidebar />
            <Box width="82%" height="100vh" bg={colorMode === 'light' ? "#F2F2F2" : "#111315"} fontFamily="heading">
                <Header />
                <Suspense fallback={<Center w="100%" h="75vh"><Spinner 
                                    thickness='4px'
                                    color='#3EA6FF'
                                    size='xl'
                                    ariaLabel='loading'
  ...
  return (
    ...
    <Box width="100vw" height="100vh" bg={colorMode === 'light' ? "#F2F2F2" : "#111315"} >
